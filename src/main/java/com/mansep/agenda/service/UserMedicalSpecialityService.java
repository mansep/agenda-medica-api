...
public interface UserMedicalSpecialityService {
        ...
        UserMedicalSpeciality update(Long id, UserMedicalSpecialityDto userMedicalSpeciality) throws NotFoundException;
        ...
        UserMedicalSpecialitiesDto saveMedicalSpecialities(UserMedicalSpecialitiesDto userMedicalSpecialitiesDto)
