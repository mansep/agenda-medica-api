...
public interface MedicalCenterService {
    ...
    MedicalCenter create(MedicalCenterDto mSpeciality) throws BadRequestException, Exception;
    MedicalCenter update(Long id, MedicalCenterDto mSpeciality) throws NotFoundException;
